                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        DropdownButtonFormField<String>(
                          ...
                          onChanged:
                              (val) =>
                                  setDialogState(() => _serviceType = val!),
                        ),
                        const SizedBox(height: 12),
                        DropdownButtonFormField<String>(
                          ...
                          onChanged:
                              (val) =>
                                  setDialogState(() => _preferredDate = val!),
                        ),
                        const SizedBox(height: 12),
                        TextField(
                          ...
                          maxLines: 2,
                          decoration: const InputDecoration(
                            labelText: 'Medical Notes / Symptoms (Optional)',
                          ),
                        ),
                      ],
                    ),
                              ...
                              : () async {
                                ...
                                try {
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    const SnackBar(
                                      content: Text(
                                        'Appointment confirmed! Queue number generated.',
                                      ),
                                    ),
                                  );
                                } catch (e) {
            ...
            body: Row(
              children: [
                SizedBox(
                  ...
                  child:
                      widget.isAdmin
                          ? const SidebarNav(selectedIndex: 5)
      ...
      children: [
        Expanded(
          child: Column(
            ...
            children: [
              Text(
                'Barangay Health & Medical Center',
              ...
              builder: (context, snapshot) {
                ...
                if (docs.isEmpty) {
                  return const Padding(
                    ...
                    child: Center(
                      child: Text(
                        'No active health appointments booked today.',
                      ),
                    ),
                  );
                }
                    ...
                    return Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Chip(
                            label: Text(data['status'] ?? 'Confirmed'),
                            backgroundColor: AppColors.primaryContainer,
                          ),
                        ],
                      ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            const Text(
              'Need immediate ambulance dispatch or emergency rescue?',
            ),
            const SizedBox(height: 16),
            Container(
              padding: const EdgeInsets.all(16),
              ...
              child: ElevatedButton.icon(
                ...
                onPressed: () {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text(
                        'Calling Barangay Ambulance Hotline (+63 917 999 1111)...',
                      ),
