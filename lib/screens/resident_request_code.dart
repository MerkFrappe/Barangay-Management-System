...
class _DashboardPageState extends State<DashboardPage> {
  ...
  Future<void> _loadResidentProfile() async {
    ...
    try {
      final document = await FirebaseFirestore.instance
          ...
          .get();
      if (document.exists) {
        _residentProfile = ResidentProfile.fromMap(document.data());
      }
    } catch (error) {
  ...
  Future<void> _uploadIdAttachment({
    ...
    try {
      ...
      await requestRef.update({'attachmentUploadStatus': 'failed'});
    }
  }
  ...
  Future<void> _submitRequest() async {
    ...
    if (profile == null || !profile.isComplete || uid == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
            'Please complete your resident profile before submitting a request.',
          ),
    ...
    try {
      ...
      final request = DocumentRequestRecord(
        requesterId: uid,
        requesterSnapshot: {
        ...
        // Current request consumers still read these legacy fields.
        residentId: uid,
  ...
  Widget _buildResidentProfileFields() {
    ...
    if (profile == null || !profile.isComplete) {
      return const Text(
        'Complete your resident profile from the dashboard to auto-fill this request.',
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _readOnlyProfileField('Full name', profile.fullName),
              const SizedBox(height: 10),
              _readOnlyProfileField('Address', profile.formattedAddress),
              const SizedBox(height: 10),
  ...
  Widget _readOnlyProfileField(String label, String value) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        border: _lockedInputBorder(),
        disabledBorder: _lockedInputBorder(),
        filled: true,
  ...
  OutlineInputBorder _lockedInputBorder() => OutlineInputBorder(
